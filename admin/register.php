...
<div class="register-box">
  <div class="register-logo">
    <a href="<?= BASE_URL_ADMIN ?>"><b>Blog Post</b></a>
  </div>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="<?= BASE_URL_ADMIN ?>pages/users/action.php" method="post">
      ...
      <a href="<?= BASE_URL_ADMIN ?>login.php" class="text-center">I already have a membership</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
